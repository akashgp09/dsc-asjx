        ...
        <div className="container">
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>1.</span> Each participant has to register on Devfolio. Confused? Watch video: <a href="">link</a>
                </div>
            </div>
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>2.</span> Team Size: 2 to 3 members
                </div>
            </div>
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>3.</span> Event is open to Undergrad Android Developers
                </div>
            </div>
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>4.</span> Accepted Languages : Kotlin/Java (Kotlin is preferred)
                </div>
            </div>
            <div className="row">
                <div className={styles.rule}>
            ...
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>6.</span> All the submissions will first be reviewed by the organizing committee & the top 10 submissions will qualify for review by a panel of judges.
                </div>
            </div>
            <div className="row">
                <div className={styles.rule}>
            ...
            <div className="row">
                <div className={styles.rule}>
                    <span className={styles.number}>8.</span> Rules can be modified by Organisers.
                </div>
            </div>
        </div>
      </div>
